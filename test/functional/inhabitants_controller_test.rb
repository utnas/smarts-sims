...
class InhabitantsControllerTest < ActionController::TestCase
  ...
  test "should create inhabitant" do
    assert_difference('Inhabitant.count') do
      post :create, inhabitant: { age: @inhabitant.age, first_name: @inhabitant.first_name, gender: @inhabitant.gender, last_name: @inhabitant.last_name }
    end
  ...
  test "should update inhabitant" do
    put :update, id: @inhabitant, inhabitant: { age: @inhabitant.age, first_name: @inhabitant.first_name, gender: @inhabitant.gender, last_name: @inhabitant.last_name }
    assert_redirected_to inhabitant_path(assigns(:inhabitant))
  end
